...
class AllPartner extends StatefulWidget {
  const AllPartner({Key? key}) : super(key: key);

  @override
  State<AllPartner> createState() => _AllPartnerState();
}

class _AllPartnerState extends State<AllPartner> {
  @override
